...
import com.don2.shopintelli.databinding.ActivityRegisterOrderProductBinding
import com.google.android.material.chip.Chip
import org.json.JSONObject
import java.text.SimpleDateFormat
import java.util.*

class RegisterProductOrderActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRegisterOrderProductBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRegisterOrderProductBinding.inflate(layoutInflater)
